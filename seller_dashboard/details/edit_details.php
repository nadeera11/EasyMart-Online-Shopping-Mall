...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($update_query)) {
        ...
        // Optionally redirect back to the view details page
...
<head>
    ...
    <script src="../js/edit_details1.js"></script>
    <!-- <script>
        window.onload = function() {
            alert('Update your shipping address here');
        };
    </script> -->
</head>
<body>
...
<div class="container">
    ...
    <div class="form-container">
        ...
        <br>
        <a class="back-link" href="../../seller_dashboard.php">Back to Dashboard</a>
    </div>
</div>
